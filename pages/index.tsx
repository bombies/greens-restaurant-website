                      ...
                      <div className='flex dark:bg-neutral-800 transition-fast'>
                          ...
                          <div className='pl-8 pt-16'>
                              <div className='flex gap-4 mb-16'>
                                  ...
                                  <h1 className='text-7xl font-bold self-center pointer-events-none dark:text-white'>Welcome back, <span className='text-green-400 dark:text-green-500'>{props.userData.first_name}</span></h1>
                              </div>
                              <div>
